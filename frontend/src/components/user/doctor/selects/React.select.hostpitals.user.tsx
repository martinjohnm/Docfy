...
export const ReactSelectHostpitalsUser = () => {
    ...
    return (
      <div className='justify-center items-center flex p-2'> 
            <Select value={curvalue} isClearable required
             className='border border-gray-300 text-black outline-none text-sm rounded-lg w-96' 
             placeholder="Select Hospital" options={hospitalOptions} onChange={handleChange} />        
      </div> 
    )
}