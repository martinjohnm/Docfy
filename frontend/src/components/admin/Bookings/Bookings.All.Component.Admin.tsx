...
import { useGetBookingsAdmin } from "../../../hooks/admin/bookings/useGetBookingsAdmin"
import { bookingsByAdminAtom, bookingTakePaginationAdmin, selectedPageNumberAdmin, totalNoOfBookingPagesAdmin, totalNoOfBookingsAdmin } from "../../../store/atoms/admin/bookingsByAdminAtoms"
import { format } from "date-fns"
import { useGetBookingAdminPerPage } from "../../../hooks/admin/bookings/useGetBookingAdminPerPage"





export const BookingsAllAdminCompoent = () => {

    useGetBookingsAdmin()
    useGetBookingAdminPerPage()
    const bookings = useRecoilValue(bookingsByAdminAtom)
    const totalNoOfBooking = useRecoilValue(totalNoOfBookingsAdmin)
    const filterNoOfRecords = useRecoilValue(bookingTakePaginationAdmin)
