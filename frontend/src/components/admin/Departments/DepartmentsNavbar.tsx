...
export const DepartmentsNavbar = ({setToggleFn}  :{setToggleFn : any}) => {
            ...
            <div className="col-span-2 justify-center items-center">
                ...
                <div className="">
                    <div className="p-4 flex justify-center items-center gap-1 max-w-3xl">
                        <input className="rounded-lg bg-slate-100 border w-full outline-none p-2" type="text" placeholder="Search For Departments" />
